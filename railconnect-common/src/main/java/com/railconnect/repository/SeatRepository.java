...
public interface SeatRepository extends JpaRepository<Seat, Long> {
    ...
    List<Seat> findAvailableSeatsWithLock(Long trainId, LocalDate date, SeatClass seatClass);
    ...
    int countByTrainDateClassStatus(Long trainId, LocalDate date, SeatClass seatClass, SeatStatus status);
